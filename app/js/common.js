document.addEventListener('DOMContentLoaded', function () {
  ...
  function equalizeOurThinkingCardHeights() {
    var cards = document.querySelectorAll('.our-thinking__card');
    if (!cards.length) {
      return;
    }
  ...
  equalizeOurThinkingCardHeights();
  window.addEventListener('load', equalizeOurThinkingCardHeights);
  window.addEventListener('resize', equalizeOurThinkingCardHeights);
...
.add(".about-hero__text-cluster-1-subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-hero__text-cluster-1__title", {
  delay: 200,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-hero__text-cluster-1-text-1", {
  delay: 300,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-hero__text-cluster-1-text-2", {
  delay: 400,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-hero__text-cluster-2-title", {
  delay: 500,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-hero__text-cluster-2-subtitle", {
  delay: 600,
  duration: 500,
  animation: "fadeInUp"
})

.add(".about-awards__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-awards__img", {
  delay: 100,
  duration: 500,
  animation: "fadeInLeft"
})
.add(".about-awards__card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".about-pharma__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-pharma__subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-pharma__card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".about-pharma__btn-row ", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".ctr-sec__subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".ctr-sec__btn-row", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".dif-hero-sec__subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-hero-sec__title", {
  delay: 200,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-hero-sec__text", {
  delay: 300,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-hero-sec__text-2", {
  delay: 400,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-hero-sec__card", {
  delay: 100,
  duration: 500,
  animation: "fadeInLeft"
})
...
.add(".dif-team-sec__subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".dif-team-sec__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".dif-team-sec__text", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".dif-team-sec__tabs", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".dif-team-sec__down-text", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-team-sec__logo", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".dif-meet-sec__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-meet-sec__img", {
  delay: 100,
  duration: 500,
  animation: "fadeInLeft"
})
.add(".dif-meet-sec__contetnt-title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-meet-sec__card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".dif-explore-sec__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-explore-sec__subtitle", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".dif-explore-sec__btn-wrapper", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
// .add(".works-hero-sec__title", {
//   delay: 200,
//   duration: 500,
//   animation: "fadeInUp"
// })
// .add(".works-hero-sec__text", {
//   delay: 300,
//   duration: 500,
//   animation: "fadeInUp"
// })
.add(".works-posts-sec__nav-list-element", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".works-posts-sec__post-card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".works-posts-sec__btn-row", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".works-results-sec__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".works-results-sec__card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".perspective-slider-sec__slider-wrapper-swiper", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".perspective-posts-sec__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".perspective-post-card", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".perspective-posts-sec__btn-row", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
...
.add(".ctr-form-sec__wrapper", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".post-hero__category", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
.add(".post-hero__title", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-subscribe-box", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__wp-editor", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__citata", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__list-v1", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__list-v2", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__list-v3--num", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__list-key", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})

.add(".post-hero-constructor__down-main-text", {
  delay: 100,
  duration: 500,
  animation: "fadeInUp"
})
